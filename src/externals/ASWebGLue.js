...
export function initASWebGLue(importObject) {
    ...
    importObject.WebGL.getString = (string_index) => {
        ...
        const str = new TextDecoder("utf-16").decode(
            buffer.slice(string_index, string_index + len)
        );
        return str;
    };
  ...
  */
    ...
    importObject.WebGL.bindAttribLocation = (ctx, program, index, name) => {
        try {
            WebGL.contextArray[ctx].bindAttribLocation(
                WebGL.programArray[program],
                index,
                WebGL.getString(name)
            );
        } catch (err) {
    ...
    importObject.WebGL.bufferSubData = (target, dstByteOffset, srcData, srcOffset, length) => {
        try {
            WebGL.contextArray[ctx].bufferSubData(
                target,
                dstByteOffset,
                WebGL.getArrayView(srcData),
                srcOffset,
                length
            );
        } catch (err) {
    ...
    importObject.WebGL.compileShader = (ctx, shader) => {
        try {
            ...
            var compilationLog = WebGL.contextArray[ctx].getShaderInfoLog(
                WebGL.shaderArray[shader]
            );
    ...
    importObject.WebGL.compressedTexImage2D = (
        ctx,
        target,
        level,
        internalformat,
        ...
        try {
            ...
            WebGL.contextArray[ctx].compileShader(
                target,
                level,
                internalformat,
                width,
    ...
    importObject.WebGL.compressedTexSubImage2D = (
        ...
        try {
            WebGL.contextArray[ctx].compressedTexSubImage2D(
                target,
                xoffset,
                yoffset,
                width,
    ...
    importObject.WebGL.copyTexImage2D = (
        ctx,
        target,
        level,
        internalformat,
        ...
        try {
            WebGL.contextArray[ctx].copyTexImage2D(
                target,
                level,
                internalformat,
                x,
    ...
    importObject.WebGL.copyTexSubImage2D = (
        ctx,
        target,
        level,
        xoffset,
        ...
        try {
            WebGL.contextArray[ctx].copyTexSubImage2D(
                target,
                level,
                xoffset,
                yoffset,
    ...
    importObject.WebGL.framebufferRenderbuffer = (
        ctx,
        target,
        attachment,
        renderbuffertarget,
        ...
        try {
            WebGL.contextArray[ctx].framebufferRenderbuffer(
                target,
                attachment,
                renderbuffertarget,
                renderbuffer
    ...
    importObject.WebGL.framebufferTexture2D = (
        ctx,
        target,
        attachment,
        textarget,
        ...
        try {
            WebGL.contextArray[ctx].framebufferTexture2D(
                target,
                attachment,
                textarget,
                texture,
    ...
    importObject.WebGL.getUniformLocation = (ctx, program, name) => {
        try {
            ...
            let uniformLocation = WebGL.contextArray[ctx].getUniformLocation(
                WebGL.programArray[program],
                WebGL.getString(name)
            );
    ...
    importObject.WebGL.linkProgram = (ctx, program) => {
        try {
            ...
            if (
                !WebGL.contextArray[ctx].getProgramParameter(
                    WebGL.programArray[program],
    ...
    importObject.WebGL.shaderSource = (ctx, shader, source) => {
        try {
            WebGL.contextArray[ctx].shaderSource(
                WebGL.shaderArray[shader],
                WebGL.getString(source)
            );
        } catch (err) {
    ...
    importObject.WebGL.texImage2D = (ctx, target, level, internalformat, format, typ, image_id) => {
      ...
      `);
            WebGL.contextArray[ctx].texImage2D(
                target,
                level,
                internalformat,
                format,
                typ,
                WebGL.imageArray[image_id]
            ); //WebGL.getArrayView(pixels));
        } catch (err) {
    ...
    importObject.WebGL.texSubImage2D = (
        ctx,
        target,
        level,
        xoffset,
        ...
        try {
            WebGL.contextArray[ctx].texSubImage2D(
                target,
                level,
                xoffset,
                yoffset,
    ...
    importObject.WebGL.uniform1fv = (ctx, location, v) => {
        try {
            return WebGL.contextArray[ctx].uniform1fv(
                WebGL.uniformLocationArray[location],
                WebGL.getArrayView(v)
            );
        } catch (err) {
    ...
    importObject.WebGL.uniform1iv = (ctx, location, v) => {
        try {
            return WebGL.contextArray[ctx].uniform1iv(
                WebGL.uniformLocationArray[location],
                WebGL.getArrayView(v)
            );
        } catch (err) {
    ...
    importObject.WebGL.uniform2fv = (ctx, location, v) => {
        try {
            return WebGL.contextArray[ctx].uniform2fv(
                WebGL.uniformLocationArray[location],
                WebGL.getArrayView(v)
            );
        } catch (err) {
    ...
    importObject.WebGL.uniform2iv = (ctx, location, v) => {
        try {
            return WebGL.contextArray[ctx].uniform2iv(
                WebGL.uniformLocationArray[location],
                WebGL.getArrayView(v)
            );
        } catch (err) {
    ...
    importObject.WebGL.uniform3fv = (ctx, location, v) => {
        try {
            ...
            return WebGL.contextArray[ctx].uniform3fv(
                WebGL.uniformLocationArray[location],
                new Float32Array(v)
            );
        } catch (err) {
    ...
    importObject.WebGL.uniform3iv = (ctx, location, v) => {
        try {
            return WebGL.contextArray[ctx].uniform3iv(
                WebGL.uniformLocationArray[location],
                WebGL.getArrayView(v)
            );
        } catch (err) {
    ...
    importObject.WebGL.uniform4f = (ctx, location, x, y, z, w) => {
        try {
            return WebGL.contextArray[ctx].uniform4f(
                WebGL.uniformLocationArray[location],
                x,
                y,
                z,
    ...
    importObject.WebGL.uniform4fv = (ctx, location, v) => {
        try {
            return WebGL.contextArray[ctx].uniform4fv(
                WebGL.uniformLocationArray[location],
                WebGL.getArrayView(v)
            );
        } catch (err) {
    ...
    importObject.WebGL.uniform4i = (ctx, location, x, y, z, w) => {
        try {
            return WebGL.contextArray[ctx].uniform4i(
                WebGL.uniformLocationArray[location],
                x,
                y,
                z,
    ...
    importObject.WebGL.uniform4iv = (ctx, location, v) => {
        try {
            return WebGL.contextArray[ctx].uniform4iv(
                WebGL.uniformLocationArray[location],
                WebGL.getArrayView(v)
            );
        } catch (err) {
    ...
    importObject.WebGL.vertexAttribPointer = (ctx, indx, size, typ, normalized, stride, offset) => {
        try {
            WebGL.contextArray[ctx].vertexAttribPointer(
                indx,
                size,
                typ,
                normalized,
    ...
    // expiramental WebGL2
    importObject.WebGL.copyBufferSubData = (
        ctx,
        readTarget,
        writeTarget,
        readOffset,
    ...
    // expiramental WebGL2
    importObject.WebGL.getBufferSubData = (
        ctx,
        target,
        srcByteOffset,
        dstBuffer,
    ...
    // expiramental WebGL2
    importObject.WebGL.framebufferTextureLayer = (
        ctx,
        target,
        attachment,
        texture,
    ...
    // expiramental WebGL2
    importObject.WebGL.invalidateSubFramebuffer = (
        ctx,
        target,
        attachments,
        x,
    ...
    // expiramental WebGL2
    importObject.WebGL.renderbufferStorageMultisample = (
        ctx,
        target,
        samples,
        internalformat,
    ...
    // expiramental WebGL2
    importObject.WebGL.texStorage3D = (
        ctx,
        target,
        levels,
        internalformat,
    ...
    // expiramental WebGL2
    importObject.WebGL.copyTexSubImage3D = (
        ctx,
        target,
        level,
        xoffset,
    ...
    // expiramental WebGL2
    importObject.WebGL.uniformMatrix3x2fv = (
        ctx,
        location,
        transpose,
        data,
    ...
    // expiramental WebGL2
    importObject.WebGL.uniformMatrix4x2fv = (
        ctx,
        location,
        transpose,
        data,
    ...
    // expiramental WebGL2
    importObject.WebGL.uniformMatrix2x3fv = (
        ctx,
        location,
        transpose,
        data,
    ...
    // expiramental WebGL2
    importObject.WebGL.uniformMatrix4x3fv = (
        ctx,
        location,
        transpose,
        data,
    ...
    // expiramental WebGL2
    importObject.WebGL.uniformMatrix2x4fv = (
        ctx,
        location,
        transpose,
        data,
    ...
    // expiramental WebGL2
    importObject.WebGL.uniformMatrix3x4fv = (
        ctx,
        location,
        transpose,
        data,
    ...
    importObject.WebGL.drawElementsInstanced = (ctx, mode, count, typ, offset, instanceCount) => {
        try {
            return WebGL.contextArray[ctx].drawArraysInstanced(
                mode,
                count,
                typ,
                offset,
    ...
    // expiramental WebGL2
    importObject.WebGL.getActiveUniformBlockParameter = (
        ctx,
        program,
        uniformBlockIndex,
        pname
    ...
    // expiramental WebGL2
    importObject.WebGL.uniformBlockBinding = (
        ctx,
        program,
        uniformBlockIndex,
        uniformBlockBinding
